        ...
        <View style={{ width: width * 0.78, height: width * 0.16, marginTop: width * 0.15, marginLeft: width * 0.11, position: 'absolute' }}>
          ...
          <View style={{ width: width * 0.26, marginLeft: '2%' }}>
            <View style={{ flexDirection: 'row', }}>
              <View style={{ width: width * 0.35, borderWidth: 1, borderColor: '#CDD4FB', marginTop: "9%", padding: 15, backgroundColor: '#EDF0FF' }}>
            ...
            <View style={{ flexDirection: 'row', }}>
              <View style={{ width: width * 0.35, borderWidth: 1, borderColor: '#CDD4FB', marginTop: -2, padding: 15 }}>
                <FONT type={"Body"}>
