...
const Lei_3= ({ navigation, language }) => {
        ...
        <View>
          ...
          <View style={{flexDirection: 'row', marginTop: width * 0.05}}>
              <View>
                  ...
                  <View style={{borderBottomWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.192}}>
                      <Button type="Nine" text={content.leiButton3} onPress={() => navigation.navigate('Business English Course')} isPressedState={true}></Button>
                  </View>
                  <View style={{borderBottomWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.192}}>
              ...
              <View style={{borderLeftWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.41, height: width * 0.15}}>
                  <FONT type="Body" style={{ marginLeft: "2%", fontSize: 18}}>{content.lei3description}</FONT>
              </View>
