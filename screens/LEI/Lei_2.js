...
const Lei_2= ({ navigation, language }) => {
        ...
        <View>
          ...
          <View style={{flexDirection: 'row', marginTop: width * 0.05}}>
              <View>
                  ...
                  <View style={{borderBottomWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.192}}>
                      <Button type="Nine" text={content.leiButton2} onPress={() => navigation.navigate('English Evening Course')}isPressedState={true}></Button>
                  </View>
                  <View style={{borderBottomWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.192}}>
                      <Button type="Nine" text={content.leiButton3} onPress={() => navigation.navigate('Business English Course')}></Button>
                  </View>
                  <View style={{borderBottomWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.192}}>
                      <Button type="Nine" text={content.leiButton4} onPress={() => navigation.navigate('Mongolian Course')}></Button>
                  </View>
              ...
              <View style={{borderLeftWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.41, height: width * 0.15}}>
                  <FONT type="Body" style={{ marginLeft: "2%", fontSize: 18}}>{content.lei2description1}</FONT>
                  <FONT type="Title3" style={{fontSize: 18, marginLeft: '2%'}}>{content.lei2description2}</FONT>
              </View>
                ...
                <View style={[styles.infoContainer, {width: width * 0.16, height: width * 0.08, padding: width * 0.0075, borderRadius: width * 0.022}]}>
                  <View style={{flexDirection: 'row'}}>
                    ...
                    <View style={{marginLeft: '5%', marginTop: '-1%'}}>
                      ...
                      <FONT style={{fontSize: 18}}> {content.lei2duration}</FONT>
                    </View>
                  </View>
                  <View style={{flexDirection: 'row', marginTop: width * 0.001}}>
                    <Calendar width={width * 0.02} height={width * 0.02}/>
                    <View style={{marginLeft: '5%'}}>
                      <FONT type="Title2" style={{fontSize: 18}}>{content.lei2DaysTitle}</FONT>
                      <FONT style={{fontSize: 18}}>{content.days}</FONT>
                    </View>
                  </View>
                </View>
