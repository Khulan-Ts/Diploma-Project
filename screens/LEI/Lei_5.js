...
const Lei_5= ({ navigation, language }) => {
        ...
        <View>
          ...
          <View style={{flexDirection: 'row', marginTop: width * 0.05}}>
              <View>
                  ...
                  <Button type="Nine" text={content.leiButton5} onPress={() => navigation.navigate('Additional Language Course')} isPressedState={true}></Button>
              </View>
              <View style={{borderLeftWidth: width * 0.0002, borderColor: "#3D2562", width: width * 0.41, height: width * 0.15}}>
                  <FONT type="Body" style={{ marginLeft: "2%", fontSize: 18}}>{content.lei5description}</FONT>
              </View>
