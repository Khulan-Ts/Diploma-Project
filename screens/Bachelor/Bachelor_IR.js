...
const Bachelor_IR= ({ navigation, language }) => {
    ...
    switch (language) {
        case 'mn':
            content = mn.bachelorIr;
            break;
        case 'ru':
            content = ru.bachelorIr;
            break;
        case 'en':
        default:
            content = en.bachelorIr;
            break;
    }
    useEffect( () => {
        ...
        >
            <View style={{flexDirection: "row", marginTop: width * 0.05}}>
                <View style={{width: width * 0.1, marginTop: '-2%'}}>
                    <Image source={require('../../assets/images/calligraphy/bachIRcal.png')} style={{width: 'auto', height: width * 0.35}} resizeMode="contain"/>
                </View>
