...
const Bachelor_MC= ({ navigation, language }) => {
    ...
    switch (language) {
        case 'mn':
            content = mn.bachelorMcMN;
            break;
        case 'ru':
            content = ru.bachelorMcRU;
            break;
        case 'en':
        default:
            content = data.bachelorMcEN;
            break;
    }
    useEffect( () => {
    ...
    return (
        ...
        >
            ...
            <View style={{borderRadius: width * 0.022, borderColor: "#CDD4FB", borderWidth: 1, width: width*0.27, marginLeft: width*0.576, marginTop: width*-0.123, shadowColor: '#CDD4FB',shadowOffset: { width: 1, height: 2 },shadowOpacity: 1,shadowRadius: 2, marginBottom: width*0.1}}>
            <View style={{marginLeft: width*0.01}}>
