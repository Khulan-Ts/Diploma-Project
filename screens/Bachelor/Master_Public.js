        ...
        >
            ...
            <View style={{
                ...
                <View style={{marginLeft: width*0.58, marginTop: width*-0.16}}>
                            <View style={[styles.infoContainer, {width: width * 0.16, height: width* 0.115, padding: width * 0.0075, borderRadius: width * 0.022}]}>
                ...
                <View style={{width: width*0.99, marginTop: width*0.01}}>
                    <ExpandableList 
