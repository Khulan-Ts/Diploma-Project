        ...
        <View style={{width: width * 0.1, marginTop: '-1%' }}>
          ...
          <View style={{flexDirection: 'column'}}>
            <View style={{flexDirection: "row", width: width*0.6,}}>
                ...
                <View style={{borderRightWidth: 1, height: height*0.05}}></View>
            ...
            <View style={{flexDirection: "row", width: width*1, marginLeft: '5.5%', marginTop: '1.5%' }}>
          ...
          <View style={{width: width * 0.1, marginLeft:'auto' }}>
