    ...
    <ScrollView style={styles.container}> 
      <View style={{ flexDirection: 'row', marginTop: 159}}>
        <View>
          ...
          <View style={{marginLeft: 157, marginTop: 33, color: ''}}>
            <Button style={{color: ''}} type="Secondary" text={'Undergraduate'}>
            </Button>
            <Button style={{color: ''}} type="Secondary" text={'Graduate'}>
            </Button> 
          </View>
        </View>
        <View style={{width: 1025, height: 151, marginLeft: 49}}>
